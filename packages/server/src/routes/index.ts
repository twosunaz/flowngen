...
router.use('/apikey', verifyToken, apikeyRouter)
...
router.use('/chatflows-uploads', verifyToken, chatflowsUploadsRouter)
router.use('/credentials', verifyToken, credentialsRouter)
router.use('/document-store', verifyToken, documentStoreRouter)
router.use('/export-import', verifyToken, exportImportRouter)
router.use('/feedback', verifyToken, feedbackRouter)
router.use('/fetch-links', verifyToken, fetchLinksRouter)
router.use('/flow-config', verifyToken, flowConfigRouter)
router.use('/internal-chatmessage', verifyToken, internalChatmessagesRouter)
router.use('/internal-prediction', verifyToken, internalPredictionRouter)
router.use('/get-upload-file', getUploadFileRouter)
router.use('/get-upload-path', getUploadPathRouter)
router.use('/leads', verifyToken, leadsRouter)
...
router.use('/nodes', verifyToken, nodesRouter)
router.use('/openai-assistants', verifyToken, openaiAssistantsRouter)
router.use('/openai-assistants-file', verifyToken, openaiAssistantsFileRouter)
router.use('/openai-assistants-vector-store', verifyToken, openaiAssistantsVectorStoreRouter)
router.use('/openai-realtime', verifyToken, openaiRealtimeRouter)
router.use('/prediction', verifyToken, predictionRouter)
...
router.use('/stats', verifyToken, statsRouter)
router.use('/tools', verifyToken, toolsRouter)
router.use('/variables', verifyToken, variablesRouter)
router.use('/vector', verifyToken, vectorRouter)
...
router.use('/auth/verify-email', verifyEmail)
